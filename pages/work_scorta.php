...
?>
    ...
    <main class="p-work">
        ...
        <section class="p-work-preview">
            ...
            <h1 class="p-work-preview__sitename">社会保険労務士事務所MPT Scorta office たかはし</h1>
            <p class="p-work-preview__date">2021-06</p>
            <div class="p-work-preview__outer">
                <div class="p-work-preview__inner js-preview-inner">
                    <div class="p-work-preview__stage js-stage">
                        <div class="p-work-preview__frame-outer js-frame-outer">
                            <iframe class="js-frame" src="https://scorta835.com/"></iframe>
                        </div>
                    </div>
                ...
                <div class="p-work-preview__bg">
                    <div class="p-work-preview__bg-cover">
                        <img src="<?php echo $path; ?>img/works/scorta_top.webp" alt="">
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="l-inner">
                <ul class="p-work-desc__list">
                    ...
                    <li class="p-work-desc__item c-card">
                        ...
                        <p class="c-card__text">初めてのご依頼で作成したWebサイトです。デザインはPhotoshopやIllustratorを使用し、ワードプレスのオリジナルテーマを作成して、HTML/CSS/jQuery/PHPを使ってコーディングしております。初めての個人案件のため時間がかかりましたが、クライアントの要望を伺いながら、ブラッシュアップして制作しました。現在も定期的な依頼をいただき、保守・更新をお手伝いしております。</p>
                    </li>
                </ul>
            </div>
            <div class="p-work-desc__button">
                <a class="c-button c-button--white u-shadow" href="https://scorta835.com/" target="_blank">
                ...
                <div class="p-work-gallery__pc">
                    ...
                    <div class="p-work-gallery__pc-img js-gallery-img c-fadein-side js-fadein-side">
                        <div class="p-work-gallery__pc-cover">
                            ...
                            <img src="<?php echo $path; ?>img/works/scorta_02.webp" alt="">
                        </div>
                    </div>
                    <div class="p-work-gallery__pc-img js-gallery-img c-fadein-side js-fadein-side">
                        <div class="p-work-gallery__pc-cover">
                            ...
                            <img src="<?php echo $path; ?>img/works/scorta_03.webp" alt="">
                        </div>
                    </div>
                    <div class="p-work-gallery__pc-img js-gallery-img c-fadein-side js-fadein-side">
                        <div class="p-work-gallery__pc-cover">
                            ...
                            <img src="<?php echo $path; ?>img/works/scorta_04.webp" alt="">
                        </div>
                    </div>
                    <div class="p-work-gallery__pc-img js-gallery-img c-fadein-side js-fadein-side">
                        <div class="p-work-gallery__pc-cover">
                            ...
                            <img src="<?php echo $path; ?>img/works/scorta_05.webp" alt="">
                        </div>
                    </div>
                </div>
                <div class="p-work-gallery__sp">
                    <div class="p-work-gallery__sp-img c-fadein-side js-fadein-side">
                        <img src="<?php echo $path; ?>img/works/scorta_sp_01.webp" alt="">
                    </div>
                    <div class="p-work-gallery__sp-img c-fadein-side js-fadein-side">
                        <img src="<?php echo $path; ?>img/works/scorta_sp_02.webp" alt="">
                    </div>
                    <div class="p-work-gallery__sp-img c-fadein-side js-fadein-side">
                        <img src="<?php echo $path; ?>img/works/scorta_sp_03.webp" alt="">
                    </div>
                </div>
            </div>
